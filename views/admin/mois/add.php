    ...
    <div class="mx-auto col-lg-6 col-md-6 mt-2 pt-4 pl-4 pr-4 elevation-1 bg-white">
        ...
        <form action="" method="POST">
            <div class="form-group">
                <label for="date" class="control-label sr-only">Date d'aujourd'hui</label>
                <input type="date" name="date" id="date" placeholder="Date d'aujourd'hui" class="form-control"/>
            </div>
